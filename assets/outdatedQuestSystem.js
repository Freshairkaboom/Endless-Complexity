function theMerchant() {
    ...
    button.firstaction = `<button class="actionButton exploreSequence" onclick="theMerchantChapter1()">Start quest</button>`;

    button.secondaction = `<button class="actionButton exploreSequence" onclick="ignoreQuest()">Ignore quest</button>`;
...
function theMerchantChapter1() {
    ...
    button.firstaction = `<button class="actionButton exploreSequence" onclick="pushStory(0)">${theMerchantQuest.responses.button1[0]}</button>`;

    button.secondaction = `<button class="actionButton exploreSequence" onclick="pushStory(1)">${theMerchantQuest.responses.button1[0]}</button>`;

    button.thirdaction = `<button class="actionButton exploreSequence" onclick=pushStory(2)">${theMerchantQuest.responses.button1[0]}</button>`;
    ...
    for (i=0; i<100; i++) {
        ...
        if (menu.status == theMerchantQuest.chapter1[i]) {
            ...
            if (chapterPush == true && theMerchantQuest.chapter1[i+1][0]) {
                ...
                button.firstaction = `<button class="actionButton exploreSequence" onclick="pushStory(0)">${theMerchantQuest.responses.button1[i+1]}</button>`;

                button.secondaction = `<button class="actionButton exploreSequence" onclick="pushStory(1)">${theMerchantQuest.responses.button2[i+1]}</button>`;

                button.thirdaction = `<button class="actionButton exploreSequence" onclick=pushStory(2)">${theMerchantQuest.responses.button3[i+1]}</button>`;
                ...
                button.firstaction = `<button class="actionButton exploreSequence" onclick="pushStory(0)">I'm looking for a quest</button>`;

                button.secondaction = `<button class="actionButton exploreSequence" onclick="pushStory(1)">Is everything okay?</button>`;

                button.thirdaction = `<button class="actionButton exploreSequence" onclick=pushStory(2)">Awfully clean hands you got</button>`;
