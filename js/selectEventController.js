...
function randomEncounter() {
    ...
    bandit.health = 40 + Math.ceil(Math.random()*21) + Math.floor(50 * monstergrowth.health);
    banditLeader.health = 80 + Math.ceil(Math.random()*41) + Math.floor(100 * monstergrowth.health);
